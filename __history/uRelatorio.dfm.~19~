object FRelatorio: TFRelatorio
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 45584.870417418980000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Relat'#243'rio de pedido por cliente')
          ParentFont = False
          Style = 'Title'
          VAlign = vaCenter
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo17: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'R$ [frxDBDataset1."total_value_item"]')
          ParentFont = False
          Style = 'Data'
        end
      end
      ...
      object Memo23: TfrxMemoView
        ...
        Frame.Typ = []
        Memo.UTF8W = (
          'R$ [frxDBDataset1."total_value_order"]')
        ParentFont = False
        Style = 'Data'
      end
    end
  ...
  object fdqRelatorio: TFDQuery
    ...
    Left = 230
    Top = 202
    object fdqRelatoriodata: TDateField
      DisplayLabel = 'Data'
      FieldName = 'data'
      Origin = 'data'
    end
    object fdqRelatoriocod_order: TIntegerField
    ...
    object fdqRelatorioclient: TStringField
      DisplayLabel = 'Cliente'
      FieldName = 'client'
      Origin = 'client'
      Size = 100
    end
    object fdqRelatorioproduct: TStringField
      DisplayLabel = 'Produto'
      FieldName = 'product'
      Origin = 'product'
      Size = 100
    end
    object fdqRelatorioquantity: TIntegerField
      DisplayLabel = 'Qtde.'
      FieldName = 'quantity'
      Origin = 'quantity'
    end
    object fdqRelatoriounit_price: TBCDField
    ...
    object fdqRelatoriototal_value_item: TFMTBCDField
    ...
    object fdqRelatoriototal_value_order: TFMTBCDField
